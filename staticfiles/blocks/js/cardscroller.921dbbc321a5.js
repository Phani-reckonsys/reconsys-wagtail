document.addEventListener("DOMContentLoaded", (event) => {
  if (window.innerWidth > 760) {
    ...
    const innerWrappersCount = document.querySelectorAll(".engagement-cards-wrapper").length;
    ...
    innerWrappers.forEach((innerWrapper, i) => {
      ...
      const scrollToSectorCard = (index) => {
        ...
        const scrollLeftValue = sectorCards[index].offsetLeft - sectorCardWrapper.offsetLeft;
      ...
      const sectorCardsLeftButton = innerWrapper.parentElement.parentElement.querySelector(".carousal-outline-btn-left");
      ...
      const sectorCardsRightButton = innerWrapper.parentElement.parentElement.querySelector(".carousal-outline-btn-right");
